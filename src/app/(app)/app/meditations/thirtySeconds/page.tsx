  ...
  if (isMeditating) {
    ...
    (window as any).onYouTubeIframeAPIReady = function () {
      player = new window.YT.Player("youtube-player", {
        videoId: "153-VXJQ_xA", // Video ID
        playerVars: {
          start: 14, // Start video at 17 seconds
        ...
        <div className="flex flex-col flex-grow p-6">
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <h1 className="text-2xl font-bold text-darkNavy mb-4">
              {isMeditating
                ? "Meditating..."
                : "Start Your 30-Second Meditation"}
            </h1>
            {isMeditating ? (
              <>
                ...
                >
                  <iframe
                    ...
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/153-VXJQ_xA?start=17&autoplay=1&controls=0&modestbranding=1&fs=0&rel=0&disablekb=1"
                    frameBorder="0"
